...
$.getJSON("/gallery/list/" + bno, function (list) {
   $(list).each(function () {
       // 파일정보 가공
...
function listFiles(bno){

	listFiles(bno);
	$.getJSON("/gallery/list/${boardVO.bno}", function(list){
		console.log(list.length);
		$(list).each(function(){
			var fileInfo = getFileInfo(this);
			str = "<li><div><a href ='"+fileInfo.getLink+"'>"+fileInfo.fileName+"<br/>"
			    + "<img src='/displayFile?fileName=" +data+"'/>" 
			    + "<input type='hidden' class='file' value='"+fileInfo.fullname+"'></li>";		
